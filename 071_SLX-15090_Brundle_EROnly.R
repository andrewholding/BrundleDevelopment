...
filename<-"Rdata/071_SLX-15090_dba_human_ER_CTCF_merged.rda"
...
t.test(report$Conc_Estrogen,report$Conc_none,alternative="greater") #p-value =  2.123e-11
...
png("plots/071_SLX15090_scatter.png", pointsize = 15)
...
#png("plots/071_HomerTSSProfile.png",pointsize=15)
