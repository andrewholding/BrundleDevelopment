...
filename<-"Rdata/014_SLX-14229_dba_mouse.rda"
if(!file.exists(filename)){
  dba<-dba(sampleSheet = "samplesheet/samplesheet_SLX14229_mm.csv")
...
png("plots/014_SLX-14229_diffbind_overlap_mouse.png",w=1000,h=1000,p=30)
...
filename<-"Rdata/014_SLX-14229_dba.counts.rda"
if(!file.exists(filename)){
  ...
  png("plots/014_SLX-14229_dba.counts.png")
  plot(dba)
  dev.off()
...
save(mmconsensus,file="Rdata/014_SLX-14229_mmconsensus.rda")
