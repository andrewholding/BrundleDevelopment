...
filename<-"Rdata/014_dba_drosophila.rda"
...
png("plots/014_diffbind_overlap_drosophila.png",w=1000,h=1000,p=30)
...
filename<-"Rdata/014_dba.counts.rda"
if(!file.exists(filename)){
  ### Only include peaks in at least 5 peaksets when generating consensus peakset
  ### Count reads 250 nucleotides upstream and downstream of the summit
...
save(dmconsensus,file="Rdata/014_dmconsensus.rda")
