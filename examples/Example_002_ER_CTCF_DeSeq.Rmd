---
title: "Normalisation Example using Internal CTCF Peaks as a Standard (No-linear Fit)"
...
In this example DiffBind was simply used as a convenient way to extract peak counts and provided consisteancy for comparision between methods. 
