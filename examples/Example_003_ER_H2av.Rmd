...
With the peak files and the seperate alignments extracted we are can then write samplesheets. For the normalization we need one for the drosphila aligned reads from each sample and the respective H2av peak file, and one for human reads from each sample and their repsective ER peak files. This forms the bais of the following analysis.
