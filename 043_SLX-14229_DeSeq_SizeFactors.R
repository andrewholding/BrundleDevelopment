...
jg.controlSampleSheet     <- "samplesheet/samplesheet_SLX14229_hs_CTCF_DBA_wCutoff.csv"
jg.experimentSampleSheet  <- "samplesheet/samplesheet_SLX14229_hs_ER_DBA_wCutoff.csv"
...
filename<-"Rdata/043_SLX-14229_dba_human_ER_CTCF.rda"
...
#Plot results
png("plots/043_SLX-14229_DeSeq_Analysis_ER.png")
...
dev.off()
png("plots/043_SLX-14229_DeSeq_Analysis_CTCF.png")
...
png("plots/043_SLX-14229_DeSeq_Analysis_ER_nocorrection.png")
...
png("plots/043_SLX-14229_DeSeq_Analysis_ER_CTCF.png")
...
png("plots/043_SLX-14229_DiffBind_Analysis_ER_nocorrection.png")
  dbaExperimentAnalysis<-dba.analyze(dbaExperiment)
  dba.plotMA(dbaExperimentAnalysis,bFlip=TRUE)
dev.off()
  
png("plots/043_SLX-14229_DiffBind_Analysis_ER.png")
...
write.csv(jg.controlResultsDeseq, file="csv/043_SLX14229_controlResultsDeseq.csv")
